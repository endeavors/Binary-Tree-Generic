/********************************************************************/
/* Name: Gurkirat Singh
 * Description: This class handles the implementation of each node
 *              in the binary search tree. It keep pointers to the 
 *              left and right child, and also the parent and the
 *              data item.
 *******************************************************************/
...
public:
  ...
  BSTNode<Data>* successor() {
    ...
    //store a pointer to the node of which we need to find the successor
    BSTNode<Data> *currentNode = this;
     
    //if there is a right, go going to the left of the right node and 
    //that is your successor
    if (currentNode->right != nullptr){
        BSTNode<Data>* successorNode = currentNode->right;
    ...
    //There is no right child of the current node
    //If there is no parent, return current node
    BSTNode<Data> *parentNode = currentNode->parent;

    //while there is a parent, keep going up until you hit the left link
