/**********************************************************************
 * Name: Gurkirat Singh
 * Description: This class keeps track of the iterator node, which is 
 *         basically a pointer to the current node. It also 
 *         implements operator overloading to compare two nodes
 *         or finding the successor node of the current node.
 *********************************************************************/
...
public:
  ...
  bool operator==(BSTIterator<Data> const & other) const {
    //If current node is not equal to the parameter node, return false
    //Else true
  ...
  bool operator!=(BSTIterator<Data> const & other) const {
    //If current node is not equal to the node passed in as parameter,
    //then return True
    //Else False
    if (this->curr != other.curr){
        return true;
